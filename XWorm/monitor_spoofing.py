...
class MonitorSpoofing:
    ...
    def main():
        ...
        parser.add_argument("--i", "--image", dest="image", nargs="?", help="Image/Video/Gif file path") # Image/Video/Gif file path
        ...
        image_path = args.image if args.image else input("Image/Video/Gif file path > ").strip().strip('"') # Get image file path
    ...
    def trigger(sock, key, image):
        try:
            payload =  f"RD-{MonitorSpoofing.SPL_XCLIENT}1024{MonitorSpoofing.SPL_XCLIENT}256{MonitorSpoofing.SPL_XCLIENT}156{MonitorSpoofing.SPL_XCLIENT}ClientID" 
            ...
            if image.lower().endswith(('.mp4', '.avi', '.mov', '.mkv')): # Video file handling
                ...
                while True:
                    ...
                    payload = f"RD+{MonitorSpoofing.SPL_XCLIENT}{encoded_frame}{MonitorSpoofing.SPL_XCLIENT}{width}{MonitorSpoofing.SPL_XCLIENT}{height}{MonitorSpoofing.SPL_XCLIENT}ClientID"
                ...
                if is_animated and image.format == "GIF":
                    while True:
                        ...
                        for frame_index in range(frame_count): # Iterate through frames
                            ...
                            width, height = frame.size # Get frame dimensions

                            payload = f"RD+{MonitorSpoofing.SPL_XCLIENT}{encoded_image}{MonitorSpoofing.SPL_XCLIENT}{width}{MonitorSpoofing.SPL_XCLIENT}{height}{MonitorSpoofing.SPL_XCLIENT}ClientID"
                    ...
                    encoded_image = base64.b64encode(compressed).decode("utf-8") # Encode to Base64
                    width, height = resized.size # Get image dimensions
